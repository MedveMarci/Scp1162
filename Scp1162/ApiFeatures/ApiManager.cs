...
public static class ApiManager
{
    ...
    {
        var name = Scp1162.Singleton.Name;
        var currentVersion = Scp1162.Singleton.Version;
    ...
    internal static string SendLogsAsync(string content)
    {
        try
        {
            var url = $"{ApiBase}/api/v1/plugin/{Uri.EscapeDataString(Scp1162.Singleton.Name)}/log";
            ...
            {
                content,
                plugin_version = Scp1162.Singleton.Version.ToString(),
