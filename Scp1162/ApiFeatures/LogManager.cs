...
internal static class LogManager
{
    ...
    private static bool DebugEnabled => Scp1162.Singleton.Config?.Debug ?? false;
    ...
    public static void Debug(string message)
    {
        ...
        Logger.Raw($"[DEBUG] [{Scp1162.Singleton.Name}] {message}", ConsoleColor.Green);
    }
    ...
    public static void Info(string message, ConsoleColor color = ConsoleColor.Cyan)
    {
        ...
        Logger.Raw($"[INFO] [{Scp1162.Singleton.Name}] {message}", color);
    }
    ...
    public static void Error(string message, ConsoleColor color = ConsoleColor.Red)
    {
        ...
        Logger.Raw($"[ERROR] [{Scp1162.Singleton.Name}] {message}", color);
    }
    ...
    public static (string logResult, bool success) GetLogHistory()
    {
        ...
        {
            stringBuilder.AppendLine("\n--- SCP-1162 Config ---\n");
            stringBuilder.Append($"{YamlConfigParser.Serializer.Serialize(Scp1162.Singleton.Config)}");
        }
